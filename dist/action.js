...
export class FileActions extends ActionsBase {
    ...
    async findOne(query) {
        ...
        for (const f of files) {
            const data = (await this.fileCpu.findOne(c_path + f, query, this.fileCpuOpts));
            if (data)
                return data;
        }
        return null;
    ...
    async update(query) {
        ...
        this._ensureQueryFormat(query);
        await this.ensureCollection(collection);
        return await this.utils.operationUpdater(this._getCollectionPath(collection), this.fileCpu.update.bind(this.fileCpu), false, query, this.fileCpuOpts);
    }
    /**
    ...
    async updateOne(query) {
        ...
        this._ensureQueryFormat(query);
        await this.ensureCollection(collection);
        const res = await this.utils.operationUpdater(this._getCollectionPath(collection), this.fileCpu.update.bind(this.fileCpu), true, query, this.fileCpuOpts);
        return res[0] ?? null;
    }
    /**
    ...
    async remove(query) {
        ...
        this._ensureQueryFormat(query);
        await this.ensureCollection(query.collection);
        return await this.utils.operationUpdater(this._getCollectionPath(collection), this.fileCpu.remove.bind(this.fileCpu), false, query, this.fileCpuOpts);
    }
    /**
    ...
    async removeOne(query) {
        ...
        this._ensureQueryFormat(query);
        await this.ensureCollection(query.collection);
        const res = await this.utils.operationUpdater(this._getCollectionPath(collection), this.fileCpu.remove.bind(this.fileCpu), true, query, this.fileCpuOpts);
        return res[0] ?? null;
    }
    /**
